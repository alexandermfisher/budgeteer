...
/**
 * Annotation to inject the currently authenticated {@link dev.amfshr.budgeteer.domain.user.User}
 ...
 *   <li>Throws {@link dev.amfshr.budgeteer.exception.ApiException} if not authenticated or user not found</li>
 * </ol>
 *

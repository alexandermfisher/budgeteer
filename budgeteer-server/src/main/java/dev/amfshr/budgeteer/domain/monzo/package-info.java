 ...
 * <h2>Entities</h2>
 * <ul>
 *   <li>{@link dev.amfshr.budgeteer.domain.monzo.MonzoConnection} - Stores encrypted Monzo OAuth tokens</li>
 * </ul>
 *
 * <h2>Security</h2>
 * <p>Monzo tokens are stored encrypted using AES-256-GCM. The encryption/decryption
 * is handled by {@link dev.amfshr.budgeteer.service.EncryptionService}, not by the entity itself.
 */
@NullMarked
